...
-- Generado desde legacy: leccion_subtema_11_kanban_flujo_visual_y_control_de_trabajo.sql
...
BEGIN TRY
    ...
    DECLARE @DescripcionLeccion NVARCHAR(500) = N'Introduce Kanban como forma visual de ordenar tareas y terminar trabajo con mÃ¡s control.';
    ...
    DECLARE @VideoId NVARCHAR(200) = N'ST11VIDPEND01';
...
<div class="leccion-teoria">
    ...
    <ul>
        ...
        <li>Evita abrir mÃ¡s trabajo del que se puede cerrar.</li>
        <li>Mejora el ritmo al enfocarse en terminar.</li>
    </ul>
    <p>Un lÃ­mite WIP es un tope de tareas abiertas al mismo tiempo.</p>
...
<div class="leccion-practicas">
    ...
    <ol>
        ...
        <li>Pon un lÃ­mite de tareas para dos columnas.</li>
        <li>Escribe que dato revisaras cada semana para medir mejora.</li>
    </ol>
    <div class="alert alert-success">
        <p class="alert-title">Criterio de logro</p>
        <p>EstÃ¡ correcto si tu tablero tiene flujo claro, limites y una mÃ©trica simple.</p>
    </div>
</div>';
...
<div class="leccion-ejemplos">
    ...
    <p>Al poner un lÃ­mite de 3 tareas en revision, el equipo cerro pendientes antes de abrir nuevas.</p>
    <p>DespuÃ©s de eso, subio la cantidad de tareas terminadas por semana.</p>
    <img src="https://placehold.co/1200x675?text=Menos+abiertas+mÃ¡s+cerradas" alt="Mejora de flujo (pendiente)">
</div>';
    DECLARE @CharpTip NVARCHAR(MAX) = N'<p><strong>Tip Charp:</strong> Cuando limitas tareas en curso, el equipo suele terminar mÃ¡s y bloquearse menos.</p>';
    DECLARE @CharpDialog NVARCHAR(MAX) = N'<p>En esta lecciÃ³n vas a usar Kanban para ordenar trabajo diario.</p><p>La meta es ver bloqueos a tiempo y mejorar el ritmo del equipo.</p>';
