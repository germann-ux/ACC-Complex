...
-- Generado desde legacy: leccion_subtema_06_diseno_software_vs_diseno_grafico_vs_diseno_ux.sql
...
BEGIN TRY
    ...
    DECLARE @TituloLeccion NVARCHAR(100) = N'DiseÃ±o de software vs diseÃ±o grÃ¡fico vs diseÃ±o UX';
    DECLARE @DescripcionLeccion NVARCHAR(500) = N'Aclara que hace cada area para no mezclar responsabilidades: software, grÃ¡fico y experiencia de uso.';
    ...
    DECLARE @VideoId NVARCHAR(200) = N'ST06VIDPEND01';
...
<div class="leccion-teoria">
    ...
    <ul>
        <li><strong>DiseÃ±o de software:</strong> organiza como funcionara el programa por dentro.</li>
        <li><strong>DiseÃ±o grÃ¡fico:</strong> define colores, estilo visual y tipografÃ­as.</li>
        <li><strong>DiseÃ±o UX:</strong> decide como sera la experiencia al usar la app.</li>
    </ul>
    <img src="https://placehold.co/1200x675?text=Software+grÃ¡fico+UX" alt="Diferencia entre areas (pendiente)">
</div>';
    DECLARE @Practica NVARCHAR(MAX) = N'
<div class="leccion-practicas">
    <h3>PrÃ¡ctica</h3>
    <ol>
        <li>Elegir colores y tipografÃ­as.</li>
        <li>Definir validaciones de contraseÃ±a.</li>
        <li>Reducir pasos de un formulario.</li>
        <li>Separar logica de datos en otra capa.</li>
    </ol>
    <p>Clasifica cada punto como software, grÃ¡fico o UX.</p>
    <div class="alert alert-success">
        <p class="alert-title">Criterio de logro</p>
        <p>EstÃ¡ correcto si explicas por que cada decision pertenece a esa area.</p>
    </div>
</div>';
...
<div class="leccion-ejemplos">
    ...
    <p><strong>GrÃ¡fico:</strong> define como se ve la pantalla.</p>
    ...
    DECLARE @CharpDialog NVARCHAR(MAX) = N'<p>En esta lecciÃ³n vas a separar tres conceptos que suelen confundirse.</p><p>La meta es entender que cada area aporta algo distinto al producto final.</p>';
