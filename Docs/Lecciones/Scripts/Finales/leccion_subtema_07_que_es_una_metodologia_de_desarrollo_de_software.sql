...
-- Generado desde legacy: leccion_subtema_07_que_es_una_metodologia_de_desarrollo_de_software.sql
...
BEGIN TRY
    ...
    DECLARE @TituloLeccion NVARCHAR(100) = N'Que es una metodologÃ­a de desarrollo de software?';
    DECLARE @DescripcionLeccion NVARCHAR(500) = N'Define que es una metodologÃ­a de desarrollo como forma de trabajo y por que ayuda a avanzar con orden.';
    ...
    DECLARE @VideoId NVARCHAR(200) = N'ST07VIDPEND01';
...
<div class="leccion-teoria">
    ...
    <img src="https://placehold.co/1200x675?text=MetodologÃ­a+como+guia+de+trabajo" alt="MetodologÃ­a como guia (pendiente)">
</div>';
...
<div class="leccion-practicas">
    ...
    <div class="alert alert-success">
        ...
        <p>EstÃ¡ correcto si conectas metodologÃ­a con resultados visibles.</p>
    </div>
</div>';
...
<div class="leccion-ejemplos">
    ...
    <div class="alert alert-error">
        <p class="alert-title">Sin metodologÃ­a</p>
        <p>Cada dia cambian prioridades y cuesta cerrar tareas.</p>
    </div>
    <div class="alert alert-success">
        <p class="alert-title">Con metodologÃ­a</p>
    ...
    DECLARE @CharpDialog NVARCHAR(MAX) = N'<p>En esta lecciÃ³n vas a entender por que un proyecto necesita una forma de trabajo.</p><p>La meta es distinguir entre trabajar mucho y avanzar de verdad.</p>';
