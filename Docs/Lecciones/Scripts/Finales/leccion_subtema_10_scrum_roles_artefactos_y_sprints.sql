...
-- Generado desde legacy: leccion_subtema_10_scrum_roles_artefactos_y_sprints.sql
...
BEGIN TRY
    ...
    DECLARE @VideoId NVARCHAR(200) = N'ST10VIDPEND01';
...
<div class="leccion-practicas">
    <h3>PrÃ¡ctica</h3>
    <ol>
        <li>Escribe 5 tareas de una funciÃ³n de tu proyecto.</li>
        <li>Elige 2 para un sprint corto.</li>
        <li>Describe que quedaria listo al final.</li>
    </ol>
    <div class="alert alert-success">
        <p class="alert-title">Criterio de logro</p>
        <p>EstÃ¡ correcto si eliges tareas realistas y un resultado concreto.</p>
    </div>
</div>';
    DECLARE @Ejemplo NVARCHAR(MAX) = N'
<div class="leccion-ejemplos">
    <h3>Ejemplo de sprint</h3>
    <p>En dos semanas se toma un grupo de tareas: crear cuenta, login y recuperar contraseÃ±a.</p>
    ...
    DECLARE @CharpTip NVARCHAR(MAX) = N'<p><strong>Tip Charp:</strong> En Scrum, terminar poco pero Ãºtil vale mÃ¡s que empezar mucho y dejarlo a medias.</p>';
    DECLARE @CharpDialog NVARCHAR(MAX) = N'<p>En esta lecciÃ³n vas a ordenar Scrum en pasos simples.</p><p>La meta es entender como se reparte el trabajo en ciclos cortos.</p>';
