...
namespace ACC.Data.Migrations
{
    ...
    [Migration("20260503224900_AddBloquesLeccion")]
    partial class AddBloquesLeccion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACC.Data.Entities.BloqueLeccion", b =>
                {
                    b.Property<int>("IdBloqueLeccion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBloqueLeccion"));
                    ...
                    b.HasKey("IdBloqueLeccion");

                    b.HasIndex("LeccionId", "Orden")
                        .IsUnique();

                    b.HasIndex("LeccionId", "TipoBloque");

                    b.ToTable("BloquesLeccion", "acc_academic");
                });
