...
-- Generado desde legacy: leccion_subtema_110_que_es_csharp_y_por_que_aprenderlo.sql
...
BEGIN TRY
    ...
    DECLARE @VideoId NVARCHAR(200) = N'ST110VIDPEND01';
    DECLARE @MermaidTitulo NVARCHAR(160) = N'Usos comunes de C#';
    DECLARE @MermaidDescripcion NVARCHAR(MAX) = N'Muestra algunos caminos donde C# se usa con frecuencia, desde aplicaciones web hasta videojuegos y servicios.';
...
<div class="leccion-teoria">
    ...
    <div class="fomentador">
        <p>Si quieres profundizar mÃ¡s en quÃ© es C# y en quÃ© tipos de proyectos se usa, puedes ver contenido mÃ¡s detallado en el capÃ­tulo sobre introducciÃ³n a C# haciendo clic <a href="Capitulo/Contenido/ID_CONTENIDO_PENDIENTE_INTRO_CSHARP">aquÃ­</a>.</p>
    </div>
</div>';
